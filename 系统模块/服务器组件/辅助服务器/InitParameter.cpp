...
VOID CInitParameter::LoadInitParameter()
{
	...
	//读取配置
	m_cbDelayList=IniData.ReadInt(TEXT("HelpServer"),TEXT("DelayList"),m_cbDelayList);
	m_wMaxConnect=IniData.ReadInt(TEXT("HelpServer"),TEXT("ConnectMax"),m_wMaxConnect);
	m_wServicePort=IniData.ReadInt(TEXT("HelpServer"),TEXT("ServicePort"),m_wServicePort);
