...
public:
	...
	//连接信息
	virtual bool SetConnectionInfo(LPCTSTR szDBAddr, WORD wPort, LPCTSTR szDBName, LPCTSTR szUser, LPCTSTR szPassword, char * pszUser1="Unknown", char * pszUser2="Unknown")=NULL;
...
public:
	//设置接口
	virtual bool SetTCPNetworkEngineEvent(IUnknownEx * pIUnknownEx, char * pszUser="Unknown")=NULL;
	//设置参数
