...
#define DTP_GP_FAKE_TABLE_INFO            1

struct DTP_GP_FakeTableInfo
{
	DWORD dwUserID;
	WORD wChairID;
	char szNickName[32];
...
#define SUB_GR_C_VIP_TRUMPET		306
#define SUB_GR_S_VIP_TRUMPET		307
#define SUB_GR_VIP_UPGRADE			309
#define SUB_GR_BROADLABA			310
...
//比赛消息结构体
//用户报名
struct CMD_GRR_MatchSignUP                                //报名比赛
{
	int nMatchID;//比赛场次ID
	DWORD dwUserID;
};
...
struct CMD_GR_MatchScoreUpdate
{
	int nMatchNum;//参数人数
...
struct CMD_GR_Match_Begin_Notify
{
...
struct CMD_GR_Match_End_Notify
{
	TCHAR szDescription[128];
	// add the rank in 
};
...
#define SUB_GRR_USER_TRANSER_DRAGON			6
#define SUB_GRO_USER_TRANSER_DRAGON			106

//赠送龙珠
struct CMD_GR_UserTransferDragon
{
	DWORD dwUserID;
	BYTE cbByNickName;
...
#define SUB_GRR_USER_USE_DRAGON				7

//使用龙珠
struct CMD_GR_UserUseDragon
{
	DWORD dwUserID;
	SCORE lUseDragon;
	TCHAR szPassword[LEN_MD5];
...
#define SUB_GRO_USER_WIN_DRAGON_PIECE 108
...
#define SUB_GR_CLOWN_FAKEANNOUNCEMENT	13								//假小丑公告
...
{
	TCHAR szClownFakeAnnounceMent[256];
};
