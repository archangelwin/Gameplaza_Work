...
#define FACE_CX_3D					92									//头像宽度
#define FACE_CY_3D					155									//头像高度

#define ONE_ROW_FACE_COUNT_3D		2									//行头像数
#define ONE_FACE_COUNT_3D			8									//头像个数
...
#define LEN_VERIFICATION_CODE		16									//验证码长度
...
#define DB_VALIDATE_PASSPOSTID		19 									//处理失败
#define DB_VALIDATE_ERROR 			20 									//处理失败
